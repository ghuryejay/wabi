...
% I'll redo the abstract on Monday, but broadly the points are:
% 1. inter-/intra-genomic repeats are the main reason assembly is complicated
% 2. in a metagenomic context repeats are not easy to find due to uneven coverage and confounding effect of strain variants
% 3. centrality has been proposed as a solution to this problem, but the original algorithms used are inefficient
% 4. Here we explore the use of approximate centrality measures and show that repeats can be accurately and efficiently detected.
